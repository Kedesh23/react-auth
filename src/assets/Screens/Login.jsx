            ...
            <div className="w-[50%] h-full">
                <div className=" px-[9em] mt-[1em]">
                    ...
                    <div className="my-[1em]">
                        ...
                        <p className="text-gray-500 text-xl">Saisissez votre email et votre mot de passe pour avoir  acces au Dashboard</p>
                    </div>
                </div>
                <div className="flex flex-col items-center my-[1em]">
                    ...
                    <div className="flex justify-between items-center my-[1em] font-bold text-2xl gap-[5px]">
                        ...
                        <Link to={'/create'} className="text-[#3D37A3]">C'est gratuit !</Link>
                    </div>
                </div>
            </div>
            <div className="bg-[#3D37A3] w-[50%] h-full">
